/*
 * This code was cloned from https://github.com/asciidoctor/asciidoctor-gradle-plugin,
 * modified adn is released under the same license
 *
 * Copyright 2013-2014 the original authors.
 * Copyright 2014 Schalk W. Cronje.
 *
 *
...
//        }
     ...
     void renderFile(final String backend,final File input) {
        project.exec {
            executable = a2xbin
...
//            }
            ...
            args AsciidocFacade.backendToCmdlineOptions(backend)
            args '--destination-dir=' + outputDir.absolutePath
            args '--verbose'
